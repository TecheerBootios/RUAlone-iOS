...
extension FeedDetail {
    class ViewModel: ObservableObject {
        ...
        @Published var region: MKCoordinateRegion = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 37.334_900-0.0055,
                                                                                                      longitude: -122.009_020),
                                                                       latitudinalMeters: 750,
                                                                       longitudinalMeters: 750)
        
        @Published var details = ExampleFeedDetailModel().mock
    }
}
